...
echo wp_kses_post( wpcmss_create_checkbox(
	array(
...
// Disable WP_Widget_Media_Gallery.
echo wp_kses_post( wpcmss_create_checkbox(
	array(
		'option' => 'remove_widget_media_gallery',
		'label'  => __( 'Gallery Widget', 'wp-cms-settings' ),
		'description' => __( 'Remove Gallery from the widgets list', 'wp-cms-settings' ),
	) )
);
